...
export default function Footer() {
	return (
		<footer className="bottom-0 z-50 bg-black mt-auto w-screen">
			<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
				<div className="flex flex-col items-center py-5 sm:flex-row-reverse sm:justify-between">
					...
					<p className="max-w-[400px] flex text-base leading-6 text-white">
