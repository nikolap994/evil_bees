	...
	return (
		<section className="py-16 md:py-24 lg:py-32 px-8 lg:px-12">
			<div className="max-w-7xl mx-auto md:p-8 lg:p-0">
				...
				<div className="relative z-10 lg:grid lg:grid-cols-2 items-baseline text-center whitespace-pre-wrap md:px-4 sm:mx-auto sm:px-0 lg:mx-0 lg:whitespace-normal">
					<div className="group flex flex-col gap-y-4 rounded-full px- 2 md:px-4 lg:rounded-r-none lg:rounded-l-xl lg:px-5 lg:py-5">
