...
export default function HardTruthCTA() {
	return (
		<section className="">
			<div className="text-white py-16 md:py-24 lg:py-32 mx-auto max-w-7xl">
				<div className="text-slate-900 py-8 px-4 md:p-8 px-12 md:mx-auto md:text-center max-w-4xl text-">
					<h2 className="text-4xl md:text-5xl tracking-tight mt-16">
					...
					<Link
						className="bg-indigo-400 py-3 px-10 text-white mt-6"
