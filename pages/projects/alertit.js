	...
	return (
		<div className="container m-auto px-6 md:px-12 xl:px-6">
			...
			<p className="mt-4 text-lg tracking-tight text-slate-700">
				...
				server, for instance? Let&#39;s verify! Track any specified service that
				is active on any port.
			</p>
			<br />
			<h2 className="font-display text-xl tracking-tight text-slate-900 sm:text-3xl">
				Keyword monitoring
			...
			<p className="mt-4 text-lg tracking-tight text-slate-700">
				To the subscribers of your Status page, send out status updates through
				email or other services you support.
			</p>
			<br />
			<h2 className="font-display text-xl tracking-tight text-slate-900 sm:text-3xl">
				Response periods
