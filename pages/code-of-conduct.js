...
export default function CodeOfConduct() {
	return (
		<div className="container m-auto px-6 md:px-12 xl:px-6 pb-14">
			...
			<br />
			<p>
				This code of conduct applies to all spaces managed by the Evill Bees, including but not limited to:
				all public and private mailing lists, issue trackers, wikis, blogs,
				Twitter; as well as any other communication channel used by our communities. A
				...
				code of conduct to be honored by all who participate in the Evil
				Bees community formally or informally, or claim any affiliation with
				the community, in any community-related activities and especially when
				representing the Evil Bees, in any role. This code is{" "}
			...
			<ol className="list-disc">
				<li>
					<p>
						...
						This applies to messages regarding help or project-related support, too.
						Not only is a public support request much more likely to result in
						an answer to a question, it also makes sure that any inadvertent
						mistakes made by people answering will be more easily detected and
						corrected.
					</p>
				</li>
				<li>
					<p>
						...
						work together to resolve conflict, assume good intentions, and do
						our best to act in an empathetic fashion. We may all experience some
						frustration from time to time, but we can not allow frustration to
						turn into any sort of personal attack. After all, a community where people feel
						uncomfortable or threatened is not a productive one. It&apos;s imperitive for all to remain
						respectful when dealing with other community members as well as those outside of our community.
					</p>
				</li>
				<li>
					<p>
						...
						make something for the benefit of the project, we must be willing to
						explain to others how it works, so that they can build on the work
						to make it even better. Any decision we make will affect users and
						colleagues, and we take those consequences seriously when making
						decisions.
					</p>
				</li>
				<li>
					<p>
						...
						encouraged, although they ought to be directed to the appropriate forum.
						Those who are asked should be responsive and helpful, within the
						context of our shared goal of improving the Evil Bees codebase.
					</p>
				</li>
				<li>
					<p>
						<strong>Be careful in with words you choose to use.</strong> Whether you are
						are participating as a professional or a volunteer, we value
						professionalism in all interactions, and take responsibility for our
						own words. Be kind to others. Never insult or put down other
						participants. Harassment and other exclusionary behavior are not
						acceptable nor will they be tolerated. This includes, but is not limited to:
					</p>
					<ul className="list-inside list-disc">
						...
						<li>
							Personal insults, especially those with racist or sexist undertones.
						</li>
						...
						<li>Advocating for, or encouraging, any of the aforementioned behavior or language.</li>
					</ul>
				</li>
				<li>
					<p>
				...
				<li>
					<p>
						...
						to ensure that others can pick up where they left off. In doing so,
						they should remain respectful of those who continue to participate
						in the project and should not misrepresent the project&#39;s goals
						or achievements. Likewise, community members should respect any
			...
			<p>
				...
				committed to being a community that consists of lighthearted jokes and positive interactions.
				Although we may not be able to satisfy everyone, we will always work to
				treat everyone as best we can. No matter how you identify yourself or how others
				...
				interactions and to encourage others to do so as well.
			</p>
			<br />
			<h2 className="z-10 max-w-4xl font-display text-l font-medium tracking-tight text-left text-slate-900 sm:text-l">
			...
			<p>
				...
				may message them in order to point out this code of conduct. Such messages may
				be in public or in private, whatever feels most appropriate. However,
				regardless of whether the message is posted publicly or not, it should still
				adhere to the relevant parts of this code of conduct; in particular, it
				should not be abusive or disrespectful.
			</p>
			<p>
				Finally, assume good faith.
				It is more likely that participants are unaware of their bad behaviour
				and are not intentionally trying to degrade the quality of the
			...
			<p>
				We strive to make this community a welcoming place for people - from all
				industries, use cases, geographies, backgrounds and walks of life. Harassment of any
			...
			<p>
				Channels are an effective way for organizing and focusing discussions while
			...
			<ul>
				<li>
					<p>
						...
						question is answered in Github Wiki, Discord Channels or in the project&apos;s README.
			...
			<ul>
				<li>
					The medium is the message. Discord can foster a welcoming, collaborative,
